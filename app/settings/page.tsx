    ...
    <section className="min-h-screen bg-[url('https://images.unsplash.com/photo-1659115516377-25ed306a3551?w=2560&q=80')] bg-cover pt-6 px-6 pb-24">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage your account, permissions, and application preferences</p>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <aside className="w-80 flex-shrink-0 hidden md:block">
            <div className="glass-card sticky top-24 rounded-xl p-6">
              <div className="mb-6">
                <h3 className="uppercase text-xs font-medium text-gray-400 tracking-wide mb-3">User Level</h3>
              ...
              <nav className="space-y-2">
                <button className="settings-nav-item glass-border settings-nav-active text-sm font-medium rounded-lg px-4 py-3 text-left w-full">General Settings</button>
                <button className="settings-nav-item text-sm font-medium rounded-lg px-4 py-3 text-left w-full text-gray-400 hover:text-white hover:bg-white/5">Account & Subscription</button>
                <button className="settings-nav-item text-sm font-medium rounded-lg px-4 py-3 text-left w-full text-gray-400 hover:text-white hover:bg-white/5">Notification Preferences</button>
              </nav>
          ...
          <div className="flex-1">
            <div className="glass-card rounded-xl p-8">
              <div className="mb-8">
                ...
                <p className="text-gray-400">Configure your application preferences and behavior</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="glass-border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <h4 className="text-sm font-medium text-white">Enable persistent settings</h4>
                      <p className="text-xs text-gray-400">Save preferences across sessions</p>
                    </div>
                    <input type="checkbox" defaultChecked className="accent-red-500" />
                  </div>
                  <div className="text-xs text-gray-500">Your settings and preferences will be automatically saved and restored when you return</div>
                </div>

                <div className="glass-border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <h4 className="text-sm font-medium text-white">Enable real-time updates</h4>
                      <p className="text-xs text-gray-400">Cargo and notifications updates</p>
                    </div>
                    <input type="checkbox" defaultChecked className="accent-red-500" />
                  </div>
                  <div className="text-xs text-gray-500">Live cargo updates (Requires Pro)</div>
                </div>

                <div className="glass-border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <h4 className="text-sm font-medium text-white">Show detailed error messages</h4>
                      <p className="text-xs text-gray-400">Display technical error information</p>
                    </div>
                    <input type="checkbox" className="accent-red-500" />
                  </div>
                  <div className="text-xs text-gray-500">Show technical details when errors occur (recommended for advanced users)</div>
                </div>

                <div className="glass-border rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <h4 className="text-sm font-medium text-white">Optimize for slower connections</h4>
                      <p className="text-xs text-gray-400">Lazy load maps and heavy content</p>
                    </div>
                    <input type="checkbox" className="accent-red-500" />
                  </div>
                  <div className="text-xs text-gray-500">Reduces data usage by loading maps and images only when needed</div>
                </div>
              </div>

              <div className="flex justify-end pt-6 border-t border-gray-700 mt-6">
                <button className="bg-gray-800 hover:bg-red-500 transition-colors px-6 py-2 rounded-lg text-white font-medium">Save Changes</button>
              </div>
            </div>
          </div>
        </div>
