    ...
    <section className="min-h-screen bg-[url('https://images.unsplash.com/photo-1659115516377-25ed306a3551?w=2560&q=80')] bg-cover pt-6 px-6 pb-24">
        ...
        <AnimateOnScroll>
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
              <button className="hover:text-white transition-colors flex items-center gap-2 text-sm text-gray-400 px-6 py-2" onClick={() => {}}>
      ...
      <Modal open={addOpen} onClose={() => setAddOpen(false)} title={t('Add New Cargo')}>
        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setAddOpen(false); }}>
          ...
          <div>
            <h3 className="text-base font-medium text-gray-300 mb-3">{t('Pricing & Additional Information')}</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
